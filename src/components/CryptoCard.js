...
const CryptoCard = ({ walletAddress }) => {
    return ( 
        <div className="flex justify-center items-center w-80 h-48vh mx-auto bg-gradient-to-r from-blue-500 to-indigo-800 rounded-lg shadow-lg">
            <div className="relative flex flex-col w-90 h-90%  rounded-md p-6">
                ...
                <div className="flex justify-between items-center mt-8">
                    <p className="text-sm font-medium tracking-wide leading-snug">CONNECTED TO</p>
                </div>
